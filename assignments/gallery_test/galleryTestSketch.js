...
function preload() {
  ...
  img = loadImage("../gallery_test/images/vangogo.jpg");
}
...
function setup() {
  ...
  audioState.preloadAudio("../gallery_test/sounds/houseMix.mp3", function () {
...
// Function to add fireworks at random positions on the screen
...
function handlePlayPause(audio) { // Function to handle play/pause (optional)
  if (audio.isPlaying) {
    audio.stopAudio();
  } else {
    audio.playAudio();
